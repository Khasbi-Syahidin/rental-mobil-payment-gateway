    ...
    <section>
            ...
            <nav class="lg:hidden relative z-40">
                <div class="flex py-6 justify-between items-center px-4">
                    ...
                    <div class="flex items-center">
                        <ul id="list"
                            class="hidden px-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16">
                            <li
                                ...
                                <form class="flex w-full p-2 px-3 rounded-lg overflow-hidden"
                                    action="{{ route('search') }}" method="get">
                                    @csrf
                                    <input type="text" required name="search" class="w-full h-10 border-slate-300"
                                        width="100%" placeholder="Search" id="search">
                                    <button type="submit" class="bg-slate-300 h-10 p-3"> <i
                            ...
                            <li class="flex  px-1 py-4 mb-5 flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
                                onclick="dropdownHandler(this)">
                                <a href="{{ route('logout')}}">
                        ...
                        <ul class="text-gray-800 lg:space-x-8 flex items-center leading-none">
                            ...
                            <li class="ml-4 hover:text-indigo-500 focus:text-indigo-500">
                                ...
                                <form class="flex w-full p-2 px-3 rounded-lg overflow-hidden"
                                    ...
                                    <input type="text" required name="search" class="w-full h-10 border-slate-300"
                                        width="100%" placeholder="Search" id="search">
                                    <button type="submit" class="bg-slate-300 h-10 p-3">Cari</button>
                                </form>
                            </li>
                        </ul>
                    ...
                    @auth
                        ...
                        @if (auth()->user() && auth()->user()->image == '')
                            <img type="button" id="menu-button" aria-expanded="true" aria-haspopup="true"
                                ...
                                class="rounded-full cursor-pointer object-cover aspect-square " width="45" height="45"
        ...
        <div class="pt-32 md:pb-32 pb-20 lg:flex items-center relative z-10 container mx-auto">
            ...
            <div role="contentinfo" class="w-full lg:w-1/2 h-full pl-4 md:pl-12 ">
                <p tabindex="0" class="text-gray-400 uppercase text-1xl mb-4">Sewa Mobil Jadi Lebih Mudah
                    bersama....</p>
                <h1 tabindex="0" class="text-gray-600 text-5xl text-semibold lg:text-6xl font-black mb-8">Sewa Mobil Bogor
                </h1>
        ...
        <div class="mx-auto container px-6 xl:px-0 py-12">
            <div class="flex flex-col">
                <div class="flex flex-col justify-center rounded-lg overflow-hidden">
                    <div class="relative">
                        <img class="sm:block w-full rounded-lg" src="{{ asset('image/iklan.png') }}" alt="sofa" />
                    </div>
                </div>
                <div class="mt-10 grid lg:grid-cols-2 gap-x-8 gap-y-8 items-center">
                    @foreach ($mobils as $mobil)
                        <a href="{{ route('mobil.show', $mobil->id) }}">
                            <div
                                class="group rounded-lg group-hover:bg-opacity-60 transition duration-500 relative bg-gray-100 dark:hover:bg-gray-700 sm:p-2 py-3 px-1 flex justify-center items-center">
                                <img class="rounded-lg group-hover:opacity-60 transition duration-500"
                                    src="{{ $mobil->image }}" alt="sofa-2" />
                                <div
