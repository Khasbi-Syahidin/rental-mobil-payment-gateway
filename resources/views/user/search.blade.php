...
<body class="antialiased m-0">
    ...
    <section id="product">
        ...
        <div class="mx-auto container px-6 xl:px-0 py-12">
            <div class="pesan w-full py-4  bg-slate-800 border-slate-500 rounded-lg hover:bg-slate-700">
                @if (count($mobils) > 0)
                    <h1 class="text-base pl-4 md:text-xl md:pl-5 lg:text-2xl font-bold text-white">
                        Menemukan {{ count($mobils) }} mobil
                    </h1>
                @else
                    <h1 class="text-base pl-4 md:text-xl md:pl-5 lg:text-2xl font-bold text-white">
